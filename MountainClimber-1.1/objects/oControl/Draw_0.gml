...
switch(room){
	...
	case EndScreen:
		...
		c_orange,c_orange,c_orange,c_orange,1);
		draw_text(room_width/2 - 200,room_height-400,"Press Enter to Try Again");
		break;
}